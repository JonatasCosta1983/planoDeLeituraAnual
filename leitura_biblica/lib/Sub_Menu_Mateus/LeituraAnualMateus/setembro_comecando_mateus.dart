...
class SetemroComecandoMateus extends StatefulWidget {
  const SetemroComecandoMateus({Key? key}) : super(key: key);

  @override
  _SetemroComecandoMateusState createState() => _SetemroComecandoMateusState();
}

class _SetemroComecandoMateusState extends State<SetemroComecandoMateus> {
  @override
        ...
        body: ListView(children: <Widget>[
          ...
          Container(
              ...
              child: GridView.count(
                  ...
                  children: <Widget>[
                    _buildCard('Setembro', context),
                    _numericabuildCard('Outubro', context),
                    _portuguesbuildCard('Novembro', context),
                    _direcionalbuildCard('Dezembro', context)
                  ]))
        ]));
  }
